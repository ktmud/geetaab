...
对着手机放一首歌，它给你一份初学者真弹得下来的吉他谱，然后横过屏幕，像唱卡拉 OK 那样跟着练。
...
的歌，最多给三档谱：简单版把七和弦、挂留音和一闪而过的经过和弦都并掉，进阶版是默认读法，
...
它会把你的手放在对的和弦上。剩下两类已知的硬骨头——小三和弦与挂二和弦只差半个音、主音和
属音容易认混——都写在下面的「Honest limits」一节里，没有藏着。
